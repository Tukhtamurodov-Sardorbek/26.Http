...
import 'package:dummy_api/widgets/richText.dart';
...
class _GETOneState extends State<GETOne> {
  ...
  SingleEmployeeParse employee = SingleEmployeeParse();
  ...
  EmployeeParsing? parseHistory(int index){
    EmployeeParsing? employee = Network.parseEmployee(history.elementAt(index)).data;
    return employee;
  }
            ...
            children: [
              ...
              MaterialButton(
                ...
                child: isPressed
                        ...
                        : const Text('GET EMPLOYEE', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
                onPressed: (){
                  _getID(_idController.text.toString().trim());
                },
              ),
              ...
              Container(
                ...
                child: employee.data != null
                    ? Center(
                    child: employeeDetailsRichText(employee.data!.id, employee.data!.name, employee.data!.salary.toString(), employee.data!.age.toString(), CupertinoColors.systemBlue)
                )
                    : const SizedBox(),
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child:
                                      employeeInfoListTile(parseHistory(index))
                                      // Text(history.elementAt(index), style: const TextStyle(fontWeight: FontWeight.bold)),
                                    )
                                  ],
                                ),
                                const Divider(color: CupertinoColors.systemBlue, thickness: 2)
