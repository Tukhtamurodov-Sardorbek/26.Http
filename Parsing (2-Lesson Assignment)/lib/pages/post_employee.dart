...
class _POSTOneState extends State<POSTOne> {
  ...
  PostEmployeeParsing newEmployee = PostEmployeeParsing();
  ...
  void _showResponse(String? _response){
    ...
    if(_response != null){
      setState(() {
        PostEmployeeParse post = Network.parsePostEmployee(_response);
        setState(() {
          newEmployee = post.data!;
          isPressed = false;
        });
        if (kDebugMode) {
          print(post.data);
              ...
              children: [
                ...
                MaterialButton(
                  ...
                  child: isPressed
                      ...
                      : const Text('POST EMPLOYEE', style: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.bold)),
                ...
                Container(
                  ...
                  child: newEmployee.id != null
                      ? employeeDetailsRichText(newEmployee.id!, newEmployee.name!, newEmployee.salary!, newEmployee.age!, CupertinoColors.systemGreen)
                      : const SizedBox(),
                  // Center(child: Text(response, style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18))),
                ),
              ],
            ),
          ),
